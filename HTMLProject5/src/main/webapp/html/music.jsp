			...
			<tr>
				...
				<td width="10%" align="center">
					...
					if (vo.getState().trim().equals("유지"))
						...
						temp = "<font color = blue>▲</font>&nbsp" + vo.getIncrement();
					else if (vo.getState().trim().equals("하강"))
						temp = "<font color = red>▼</font>&nbsp" + vo.getIncrement();
					%> <%=temp%></td>
				<td width="20%" align="center"><img src="<%=vo.getPoster()%>"
					width="30" height="30"></td>
				<td width="30%" align="center"><%=vo.getTitle()%></td>
				<td width="30%" align="center"><%=vo.getSinger()%></td>
			</tr>
			<%
			}
			%>
