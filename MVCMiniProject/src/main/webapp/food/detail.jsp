		...
		<main class="container clear">
			...
			<table class="table">
				<tr>
					...
					<td colspan="2">
						<h3>${detail.name}&nbsp;<span style="color: orange;">${detail.score}</span>
						</h3>
					</td>
				</tr>
				<tr>
					<th width="20%" class="text-center">주소</th>
					<td width="50%">${detail.addr }</td>
				</tr>
				<tr>
			...
			<table class="table">
				...
				<tr>
					<td class="text-right">
						<a href="../food/review.do?fno=${detail.fno}" class="btn btn-sm btn-success">리뷰</a>
			...
			<h2 class="sectiontitle">인근 명소</h2>
