		...
		<div class="row">
			<table class="table">
				<tbody>
					...
					<tr>
						<td width="30%" colspan="4" class="text-left" valign="top" height="200">
					...
					<tr>
						<td colspan="4" class="text-right">
							...
							<span class="btn btn-sm btn-danger" id="delclick">삭제</span>
					...
					<tr style="display: none;" id="del">
						<td colspan="4" class="text-right">
							비밀번호 :
							<input type="password" size="15" name="pwd" class="input-sm" id="pwd">
							<button class="btn-sm btn-danger" data-no="<%=no%>" id="delex">삭제</button>
						</td>
					</tr>
				</tbody>
			</table>
