...
DiaryVO vo=dao.diaryInfoData(Integer.parseInt(no));
%>
<!DOCTYPE html>
<html>
<head>
				...
				<table class="table">
					<tbody>
						<tr>
							<td colspan="2">
								년도:
								<input type="text" size=10 class="input-sm" name=year value="<%=vo.getYear()%>">
								&nbsp; 월:
								<input type="text" size=10 class="input-sm" name=month value="<%=vo.getMonth()%>">
								&nbsp; 일:
								<input type="text" size=10 class="input-sm" name=day value="<%=vo.getDay()%>">
